...
public class DeliveryFeeMonetaryFields {
     ...
     * @param currency
     */
    public DeliveryFeeMonetaryFields(String currency, String displayString, Object unitAmount, Integer decimalPlaces) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeliveryFeeMonetaryFields) == false) {
            return false;
        }
        DeliveryFeeMonetaryFields rhs = ((DeliveryFeeMonetaryFields) other);
